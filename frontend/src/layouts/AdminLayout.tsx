    ...
    <div className="min-h-screen flex bg-nexus-900">
      ...
      <div className={`flex-1 transition-all duration-300 ${collapsed ? 'ml-[68px]' : 'ml-[240px]'}`}>
        ...
        <header className="sticky top-0 z-30 h-16 flex items-center justify-between px-6 border-b border-magenta-glow/[0.06] bg-nexus-900/80 backdrop-blur-xl">
          <div ref={searchRef} className="relative flex items-center gap-3 flex-1 max-w-md">
            {searchLoading ? (
                  ...
                  <div>
                    ...
                    {results!.users!.slice(0, 5).map((u: unknown) => {
                      ...
                      return (
                        ...
                        >
                          <User size={14} className="text-magenta-glow shrink-0" />
                    ...
                    {results!.projects!.slice(0, 5).map((p: unknown) => {
                      ...
                      return (
                        <Link
                          ...
                          className="flex items-center gap-3 px-4 py-2.5 hover:bg-nexus-700/30 transition-colors no-underline"
                        >
                          <FolderOpen size={14} className="text-violet-glow shrink-0" />
                          <div className="min-w-0">
                  ...
                  <div>
                    ...
                    {results!.subscribers!.slice(0, 5).map((s: unknown) => {
                      ...
                      return (
                        ...
                        >
                          <UserPlus size={14} className="text-cyan-glow shrink-0" />
                          <div className="min-w-0">
                    ...
                    {results!.integrations!.slice(0, 5).map((int: unknown) => {
                      ...
                      return (
                        <Link
                          ...
                          className="flex items-center gap-3 px-4 py-2.5 hover:bg-nexus-700/30 transition-colors no-underline"
                        >
                          <Plug size={14} className="text-emerald-glow shrink-0" />
                          <div className="min-w-0">
