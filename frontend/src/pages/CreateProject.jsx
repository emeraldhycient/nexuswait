...
import {
  ArrowRight, ArrowLeft, Palette, Globe, Mail, Share2,
  Sparkles, Check, Copy, Code
} from 'lucide-react'
          ...
          <div className="text-center animate-fade-in py-4">
            ...
            <div className="mt-6 card-surface p-4 text-left">
              <div className="flex items-center justify-between mb-2">
                ...
                <button className="text-nexus-500 hover:text-cyan-glow transition-colors"><Copy size={13} /></button>
              </div>
...
<div id="nexuswait" data-id="prj-005"></div>`}
            ...
            <button
              onClick={() => navigate('/dashboard/project/prj-005')}
              className="btn-primary mt-6 inline-flex items-center gap-2"
            >
              Deploy & Go Live <ArrowRight size={14} />
            </button>
          </div>
        )}
      </div>
