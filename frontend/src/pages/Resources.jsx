...
const guides = [
  { title: 'The Ultimate Pre-Launch Playbook', tag: 'Guide', time: '12 min read', color: 'cyan' },
  { title: 'Referral Loops That 10x Your Signups', tag: 'Strategy', time: '8 min read', color: 'magenta' },
  { title: 'Building a Waitlist with Next.js + NexusWait', tag: 'Tutorial', time: '15 min read', color: 'violet' },
  { title: 'Advanced Segmentation Techniques', tag: 'Advanced', time: '10 min read', color: 'emerald' },
]
              ...
              >
                <div className="flex items-start gap-4 mb-4">
                  <div className="w-9 h-9 rounded-lg bg-cyan-glow/8 border border-cyan-glow/15 flex items-center justify-center shrink-0">
                    <cat.icon size={16} className="text-cyan-glow" />
                  </div>
                  <div>
