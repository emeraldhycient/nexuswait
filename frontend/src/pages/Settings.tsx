        ...
        <div className="flex-1 max-w-xl">
          {activeTab === 'profile' && (
            <div className="animate-fade-in space-y-6">
              ...
              <button type="button" onClick={save} className="btn-primary flex items-center gap-2">
            ...
            <div className="animate-fade-in space-y-5">
              <div className="card-surface p-6">
                ...
                <div className="space-y-4">
                  ...
                  <button type="button" className="btn-primary text-xs">Update Password</button>
                </div>
              </div>
              ...
              <div className="card-surface p-6">
                ...
                <div className="flex items-center gap-2 p-3 rounded-lg bg-nexus-900/50 border border-nexus-700/30">
                  ...
                  <button type="button" className="text-xs text-cyan-glow/70 hover:text-cyan-glow font-mono">Copy</button>
                </div>
                <button type="button" className="btn-ghost text-xs mt-3">Regenerate Key</button>
              </div>
            </div>
          )}
            ...
            <div className="animate-fade-in space-y-5">
              <div className="card-surface p-6">
                ...
                <div className="flex gap-2">
                  <button type="button" className="btn-secondary text-xs py-1.5 px-3">Change Plan</button>
              ...
              <div className="card-surface p-6">
                ...
                <button type="button" className="btn-ghost text-xs mt-3">Update Payment Method</button>
              </div>
            </div>
          )}
        </div>
